...
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=input_monitor' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/input-monitor.o
...
$(builddir)/input_monitor.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/input_monitor.node: LIBS := $(LIBS)
$(builddir)/input_monitor.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/input_monitor.node: TOOLSET := $(TOOLSET)
$(builddir)/input_monitor.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/input_monitor.node
# Add target alias
.PHONY: input_monitor
input_monitor: $(builddir)/input_monitor.node

# Short alias for building this executable.
.PHONY: input_monitor.node
input_monitor.node: $(builddir)/input_monitor.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/input_monitor.node
