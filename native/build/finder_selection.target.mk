...
TOOLSET := target
TARGET := finder_selection
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=finder_selection' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	$(obj).target/$(TARGET)/finder-selection.o
...
$(builddir)/finder_selection.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/finder_selection.node: LIBS := $(LIBS)
$(builddir)/finder_selection.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/finder_selection.node: TOOLSET := $(TOOLSET)
$(builddir)/finder_selection.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/finder_selection.node
# Add target alias
.PHONY: finder_selection
finder_selection: $(builddir)/finder_selection.node

# Short alias for building this executable.
.PHONY: finder_selection.node
finder_selection.node: $(builddir)/finder_selection.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/finder_selection.node
